    ...
    $.ajax({
        ...
        method: 'GET'
          ...
          for (var i = 0; i <= response.results.length; i++) {
            ...
            newRow.append('<td>' + response.results[i].title + '</td>');
            newRow.append('<td><a href="'+ response.results[i].url + ' target="_blank"><button type="button" class="btn btn-info">Read More</button></td>');            
